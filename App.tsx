      ...
      <ToastProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/signup"  element={<SignupPage role="member" />} />
            <Route path="/signup/member"  element={<SignupPage role="member"  />} />
            <Route path="/signup/lead"    element={<SignupPage role="lead"    />} />
